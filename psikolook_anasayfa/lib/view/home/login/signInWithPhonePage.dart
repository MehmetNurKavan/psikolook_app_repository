             ...
             children: [
               FloatingActionButton.small(
                        ...
                        Row(
                          ...
                          children: [
                            SizedBox(width: 10.0,),
                            Text("Telefon:",style:TextStyle(fontSize: 13,fontWeight: FontWeight.bold)),
                          ],
                        ),
                        Column(
                     ...
                     decoration: InputDecoration(
                      ...
                      border: OutlineInputBorder(
                        ...
                        TextButton(
                          ...
                          onPressed: () {
                          Navigator.push( context,MaterialPageRoute(builder: (context) => const SignInPage()));
                        }, child: Text("E-Mail ile Giriş Yap",style: TextStyle(color: Color(0xFFFF0390),fontWeight: FontWeight.bold,
                        fontSize: 16),)),
                        Row(
                          mainAxisAlignment: MainAxisAlignment.end,
                          children: [
