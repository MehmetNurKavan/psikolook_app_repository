               ...
               children: [
                 FloatingActionButton.small(
                          ...
                          Row(
                            ...
                            children: [
                              SizedBox(width: 10.0,),
                              Text("E-Mail:",style:TextStyle(fontSize: 13,fontWeight: FontWeight.bold)),
                            ],
                          ),
                          Column(
                        ...
                        border: OutlineInputBorder(
                           ...
                           Row(
                            mainAxisAlignment: MainAxisAlignment.start,
                             children: [
                              SizedBox(width: 10.0,),
                               Text("Şifre:",style:TextStyle(fontSize: 13,fontWeight: FontWeight.bold)),
                             ],
                           ),                      
                          Column(
                            mainAxisAlignment: MainAxisAlignment.end,
                       ...
                       decoration: InputDecoration(
                        ...
                        border: OutlineInputBorder(
                          ...
                          }, child: Text("Telefon Numarasıyla Giriş Yap",style: TextStyle(color: Color(0xFFFF0390),fontWeight: FontWeight.bold,
                          fontSize: 16),)),
                          Row(
                            mainAxisAlignment: MainAxisAlignment.end,
                            children: [
                        ...
                        }, child: Text("Şifremi Unuttum",style:TextStyle(color:Colors.grey,fontWeight: FontWeight.w400))),
