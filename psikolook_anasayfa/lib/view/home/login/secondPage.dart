            ...
            child: Center(
              child: Column(
                ...
                children: [
                 ...
                 Text("Hoş Geldin!",style: TextStyle(fontSize: 40.0,decoration: TextDecoration.none,color: Colors.white,
                 fontStyle:FontStyle.italic,fontWeight:FontWeight.normal ),),
                 //SizedBox(height: MediaQuery.of(context).size.height*0.2),
                 Container(
                  width: MediaQuery.of(context).size.width*0.9,
                   child: Text("Psikologlarımızla beraber bir yolculuğa çıkmaya ne dersin?",textAlign: TextAlign.center,
