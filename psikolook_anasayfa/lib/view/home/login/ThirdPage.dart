              ...
              child: Column(
                ...
                children: [
                  Padding(
                    ...
                    child:Container(
                    alignment: Alignment(MediaQuery.of(context).size.height*0.0013, -5.0),
                      child: SizedBox(
                 ...
                 Container(
                  width: MediaQuery.of(context).size.width*0.9,
                   child: Text("Psikolook sana en uygun psikologu bulmanı sağlar",textAlign: TextAlign.center,
